...
contract Games is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    constructor(uint256 _minimumBet, uint64 subscriptionId, address consumer_address) 
    payable
    VRFConsumerBaseV2(consumer_address)
    ConfirmedOwner(msg.sender)
    {
       owner = msg.sender;
        minimumBet = _minimumBet;
        COORDINATOR = VRFCoordinatorV2Interface(consumer_address);
